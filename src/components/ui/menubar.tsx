...
function MenubarContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn("min-w-36 rounded-lg bg-popover p-1 text-popover-foreground shadow-md ring-1 ring-foreground/10          ", className )}
      {...props}
    />
  )
}
...
function MenubarSubContent({
  ...
  return (
    <DropdownMenuSubContent
      ...
      className={cn("min-w-32 rounded-lg bg-popover p-1 text-popover-foreground shadow-lg ring-1 ring-foreground/10           ", className )}
      {...props}
    />
  )
}
